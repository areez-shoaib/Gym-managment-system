  ...
  return (
    ...
    >
      ...
      <Container maxWidth="xl" sx={{ py: 4 }}>
        <Box sx={{ display: 'flex', gap: 3, flexDirection: { lg: 'row', xs: 'column' } }}>
          {/* Main Content */}
          <Box sx={{ flex: 1, display:"flex",gap:{lg:6,md:17}}}>
            {/* Stats Cards */}
            <Grid container spacing={3} sx={{ mb: 6, justifyContent: 'center',flexDirection:"column" }}>
          <Grid item xs={12} sm={6} md={6} lg={6} sx={{ minWidth: 280, maxWidth: 350 }}>
            <Paper
              elevation={3}
              sx={{
                p: 3,
