                ...
                <Select
                  ...
                  sx={{
                    ...
                    '& .MuiSelect-select.MuiSelect-selectMenu': {
                      color: formData.gender ? 'white' : 'rgba(255,255,255,0.7)',
                    },
                      }}
                >
              ...
              <FormControl fullWidth>
                <Select
                  ...
                  sx={{
                    ...
                    '& .MuiSelect-select.MuiSelect-selectMenu': {
                      color: formData.bloodGroup ? 'white' : 'rgba(255,255,255,0.7)',
                    },
                  }}
                >
              ...
              <FormControl fullWidth>
                ...
                <Select
                  ...
                  sx={{
                    ...
                    '& .MuiSelect-select.MuiSelect-selectMenu': {
                      color: formData.membershipType !== 'monthly' ? 'white' : 'rgba(255,255,255,0.7)',
                    },
                    '& .MuiInputLabel-root': {
                      color: 'rgba(255, 255, 255, 0.9)',
                      '&.Mui-focused': {
                ...
                >
                  <MenuItem value="" disabled>Select Membership Type</MenuItem>
        ...
        <DialogContent>
          <Box sx={{ textAlign: 'center', py: 2 }}>
            ...
            <Typography variant="body2" sx={{ color: 'rgba(255, 255, 255, 0.8)' }}>
              Your member has been successfully registered in the gym management system.
            </Typography>
          </Box>
        </DialogContent>
